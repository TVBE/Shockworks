...
#include "ShockworksSoundsetEntry.generated.h"
...
struct FShockworksSoundsetEntry
{
	...
	FShockworksSoundsetEntry(FVector2D const InRange, FVector2D const OutRange)
	{
		FadeInRange = InRange;
